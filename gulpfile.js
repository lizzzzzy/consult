...
//var postcssMedia = require("postcss")
...
gulp.task('default', function() {
  gulp.start('twig', 'styles', 'scripts', 'img');
});

// Запуск живой сборки
gulp.task('live', function() {
  gulp.start('twig', 'styles', 'scripts', 'img', 'watch', 'server');
});

// Cборка с вотчем без браузерсинка
gulp.task('no-server', function() {
  gulp.start('twig', 'styles', 'scripts', 'img', 'watch');
});
